...
10  RETURN
  ...
  SUBROUTINE lmdif2(fcn,m,n,x,fvec,tol,diag,sig,info,iwa)
...
!!$    write(*,*)" lmdif2 setted tolerances: "
...
10  RETURN
  ...
  SUBROUTINE lmdif(fcn,m,n,x,fvec,ftol,xtol,gtol,maxfev,epsfcn, &
    ...
    !       minpack-supplied ... PRmpar,enorm,fdjac2,lmpar,qrfac
...
300 IF (iflag < 0) info = iflag
  ...
  SUBROUTINE lmpar(n,r,ipvt,diag,qtb,delta,par,x,sdiag)
    ...
    !       minpack-supplied ... PRmpar,enorm,qrsolv
